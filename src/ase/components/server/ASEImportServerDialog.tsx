...
export default function ASEImportServerDialog({ onClose }: Props) {
    ...
    const { addServer } = useAseServerStore();
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 border border-slate-700/50 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="p-6 space-y-5 overflow-y-auto flex-1">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="px-3 py-1.5 rounded-lg bg-amber-500/20 border border-amber-500/40 text-amber-300 text-xs font-bold">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                        ...
                        <div className="text-sm text-amber-300/80">
                            ...
                            <ul className="list-disc list-inside text-xs space-y-0.5 opacity-80">
                                ...
                                <li>BattlEye configuration and custom launch arguments</li>
                            </ul>
                        </div>
                    </div>
                </div>
