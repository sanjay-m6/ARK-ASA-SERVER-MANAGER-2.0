...
pub struct AseGameConfig {
    ...
    pub player_harvesting_damage_multiplier: f64,
    pub player_base_stat_multipliers: Vec<f64>,
    pub per_level_stats_multiplier_player: Vec<f64>,
    pub level_experience_ramp_overrides: String,
    pub override_max_experience_points_player: String,
    pub override_max_experience_points_dino: String,
    ...
    pub crafting_skill_bonus_multiplier: f64,
    pub max_fall_speed_multiplier: f64,
    pub tamed_dino_damage_multiplier: f64,
    pub tamed_dino_resistance_multiplier: f64,
    pub b_use_tame_limit_for_structures_only: bool,
    ...
    pub b_disable_dino_riding: bool,
    pub b_disable_dino_taming: bool,
    pub b_disable_dino_breeding: bool,
    pub dino_spawn_weight_multipliers: Vec<String>,
    pub dino_class_damage_multipliers: Vec<String>,
    pub dino_class_resistance_multipliers: Vec<String>,
    pub tamed_dino_class_damage_multipliers: Vec<String>,
    pub tamed_dino_class_resistance_multipliers: Vec<String>,
    ...
    pub per_level_stats_multiplier_dino_tamed_affinity: Vec<f64>,
    pub mutagen_level_boost_array: Vec<u32>,
    pub mutagen_level_boost_bred_array: Vec<u32>,
    ...
    pub new_save_game_format: bool,
    pub use_store: bool,
    pub backup_transfer_player_datas: bool,
    pub motd_interval_enabled: bool,
...
impl Default for AseGameConfig {
    fn default() -> Self {
        Self {
            ...
            player_base_stat_multipliers: vec![1.0; 12],
            per_level_stats_multiplier_player: vec![1.0; 12],
            level_experience_ramp_overrides: String::new(),
            override_max_experience_points_player: String::new(),
            override_max_experience_points_dino: String::new(),
            ...
            prevent_offline_pvp_interval: 900,
            b_disable_structure_placement_collision: false,
            b_use_corpse_locator: true,
            b_show_status_types: true,
            b_allow_unlimited_respecs: false,
            ...
            b_use_tame_limit_for_structures_only: false,
            ...
            b_allow_flying_stamina_recovery: false,
            b_allow_multiple_attached_c4: false,
            disable_dino_decay_pvp: false,
            b_allow_flyer_speed_leveling: false,
            b_allow_unclaim_dinos: true,
            b_disable_dino_riding: false,
            b_disable_dino_taming: false,
            b_disable_dino_breeding: false,
            dino_spawn_weight_multipliers: Vec::new(),
            dino_class_damage_multipliers: Vec::new(),
            dino_class_resistance_multipliers: Vec::new(),
            tamed_dino_class_damage_multipliers: Vec::new(),
            tamed_dino_class_resistance_multipliers: Vec::new(),
            ...
            per_level_stats_multiplier_dino_tamed_affinity: vec![1.0; 12],
            mutagen_level_boost_array: vec![0; 12],
            mutagen_level_boost_bred_array: vec![0; 12],
            backup_quantity: 20,
            new_save_game_format: false,
            use_store: false,
            backup_transfer_player_datas: false,
            motd_interval_enabled: false,
            motd_interval: 60,
